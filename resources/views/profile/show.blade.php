            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        @else
                            <img src="https://cdn.business2community.com/wp-content/uploads/2017/08/blank-profile-picture-973460_640.png" alt="Profile picture" height="64" class="rounded-circle">
                        @endif
                                    ...
                                    <div class="modal-body">
                                        @foreach ($followers as $follower)
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                @else
                                                    <img src="https://cdn.business2community.com/wp-content/uploads/2017/08/blank-profile-picture-973460_640.png" alt="Profile picture" height="32" class="rounded-circle">
                                                @endif
                                                <h4 class="ml-2 mb-0">{{ $follower->name }}</h4>
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
